...
if _cached:
    ...
    st.info(
        ...
        "Click **Scrape market universe** below to fetch all stores from Google Places for this area. "
        "This runs once — every future pipeline run reuses this data automatically at zero API cost."
    )
